                ...
                <div className={comment.commentsPO.parentId === 0 ? "Father-comment" : "child-comment"}>
                    ...
                    <div className="comment-mainWrapper">
                        ...
                        <div className={comment.commentsPO.parentId === 0 ? "commentTooltable" : "childcomment-ToolTable"}>
                            ...
                            {comment.sendUserId === userData.userId && <span className={comment.commentsPO.parentId === 0 ? "comment-delete" : "child-comment-delete"}><Popconfirm title="确定要删除这个吗" okText="是的" cancelText="再说" onConfirm={() => handleDeleteComment(comment.commentsPO.commentId)}><DeleteOutlined /></Popconfirm></span>}
